...
バイナリ構造は[NX Macro Controller](https://blog.bzl-web.com/entry/2020/01/20/165719)の方式[^7]に準拠します。パッド座標は左上起点で、ニュートラルポジションは128です。右パッドは将来の更新のために予約されています。
